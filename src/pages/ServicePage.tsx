      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <AnimatedSection className="bg-seo-gray-light p-8 rounded-xl mt-12" animation="fade-in">
              <h3 className="text-2xl font-display font-bold text-seo-dark mb-4">
                Ready to Improve Your {service.title} Performance?
              </h3>
              <p className="text-lg text-seo-gray-dark mb-6">
                Get in touch with our team today for a free consultation and discover how our {service.title.toLowerCase()} service can help your business grow.
              </p>
              <Link
                to="/contact"
