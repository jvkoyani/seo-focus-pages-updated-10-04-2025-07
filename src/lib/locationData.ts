...
const southAustralianCities: Location[] = [
  ...
  "Lake Albert", "Lake Alexandrina", "Lake Carlet", "Lake Everard", "Lake Eyre", "Lake Frome", "Lake Gairdner", "Lake Gilles", 
  "Lake Harris", "Lake Macfarlane", "Lake Plains", "Lake Torrens", "Lake Torrens Station", "Lake View", "Lameroo", 
  "Langhorne Creek", "Langs Landing", "Largs Bay", "Largs North", "Laura", "Laura Bay", "Laurie Park", "Leabrook", "Leasingham", 
  "Leawood Gardens", "Leigh Creek", "Leigh Creek Station", "Leighton", "Lenswood", "Lewiston", "Light Pass", "Lightsview", 
  "Lincoln Gap", "Lincoln National Park", "Linden Park", "Lindley", "Lindon", "Linwood", "Lipson", "Little Douglas", "Littlehampton", 
  "Lobethal", "Lochaber", "Lochiel", "Lock", "Lockes Claypan", "Lockleys", "Long Flat", "Long Plains", "Longwood", "Lonsdale", 
  "Lonsdale Dc", "Louth Bay", "Loveday", "Lowan Vale", "Lowbank", "Lower Broughton", "Lower Hermitage", "Lower Inman Valley", 
  "Lower Light", "Lower Mitcham", "Loxton", "Loxton North", "Lucindale", "Lucky Bay", "Lyndhurst", "Lyndoch", "Lynton", "Lyrup", 
  "Maaoupe", "Mabel Creek", "Macclesfield", "Macdonald Park", "Macgillivray", "Macumba", "Magarey", "Magdala", "Maggea", "Magill", 
  "Magill North", "Magill South", "Mahanewo", "Maitland", "Makin", "Malinong", "Mallala", "Malpas", "Maltee", "Malvern", "Mambray Creek", 
  "Mangalo", "Manna Hill", "Mannanarie", "Manners Well", "Manningham", "Mannum", "Manoora", "Mansfield Park", "Mantung", "Manunda Station", 
  "Marama", "Marananga", "Marble Hill", "Marcollat", "Marden", "Marino", "Marion", "Marion Bay", "Markaranka", "Marks Landing", "Marla", 
  "Marleston", "Marleston Dc", "Marola", "Marrabel", "Marree", "Marree Station", "Marryatville", "Martins Well", "Maryvale", "Maslin Beach", 
  "Matta Flat", "Maude", "Mawson Lakes", "Mayfield", "Maylands", "Mcbean Pound", "Mccallum", "Mccracken", "Mcdouall Peak", "Mcharg Creek", 
  "Mclaren Flat", "Mclaren Vale", "Meadows", "Medindie", "Medindie Gardens", "Melrose", "Melrose Park", "Melrose Park Dc", "Melton", "Melton Station", 
  "Meningie", "Meningie East", "Meningie West", "Menzies", "Mercunda", "Merghiny", "Meribah", "Merriton", "Merty Merty", "Middle Beach", 
  "Middle River", "Middleback Range", "Middleton", "Midgee", "Mil Lel", "Milang", "Mile End", "Mile End South", "Milendella", "Millbrook", 
  "Millers Creek", "Millicent", "Millswood", "Miltalie", "Minbrie", "Minburra", "Minburra Plain", "Minburra Station", "Mindarie", "Mingary", 
  "Mingbool", "Minlaton", "Minnipa", "Mintabie", "Mintaro", "Minvalara", "Miranda", "Mitcham", "Mitcham Shopping Centre", "Mitchell", "Mitchell Park", "Mitchellville"
